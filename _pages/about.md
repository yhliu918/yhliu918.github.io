...
### Database Papers
  ...
  **Yihao Liu**, Shaoxuan Tang, Yulong Hui, Hangrui Zhou, Huanchen Zhang  
  [PDF](https://people.iiis.tsinghua.edu.cn/~huanchen/publications/slm-vldb25.pdf) | [Code](https://github.com/yhliu918/duckdb/tree/latest) 
...
### LLM Papers 
  ...
  **SIGMOD '26** | **Scale-Doc: Scaling LLM-based Predicates over Enormous Documents**  
  ...
  **Preprint** | **Nirvana: A Specialized Generalist Model With Task-Aware Memory Mechanism**  
  Yuhua Jiang, Shuang Cheng, **Yihao Liu**, Ermo Hua, Che Jiang, Weigao Sun, Yu Cheng, Feifei Gao, Biqing Qi, Bowen Zhou
  [PDF](https://arxiv.org/abs/2510.26083) 
